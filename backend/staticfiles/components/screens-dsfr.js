        ...
        : `
            ...
            .map((result, _index) => `
                            <div class="result-card result-${result.result}">
                                <h3>Test #{} - ${new Date(result.test_date).toLocaleDateString('fr-FR')}</h3>
            ...
            poor: 'Faible',
                                ...
                                <div class="result-details">
                                    ...
                                    <p><strong>Suivi:</strong> ${result.tracking_percentage.toFixed(1)}%</p>
                                    <p><strong>Fixations:</strong> ${result.fixation_count}</p>
                                    <p><strong>Stab. gaze:</strong> ${result.gaze_stability.toFixed(2)}</p>
                                </div>
                            </div>
                        `)
            .join('')}
...
//# sourceMappingURL=screens-dsfr.js.map