            ...
            <div class="container">
                <div class="results-header">
                    ...
                    <div class="results-stats-summary">
                        ...
                        <div class="stat-box">
                            <span class="stat-number">${state.testResults.length > 0 ? (state.testResults.reduce((sum: number, t: any) => sum + t.tracking_percentage, 0) / state.testResults.length).toFixed(1) : 0}%</span>
