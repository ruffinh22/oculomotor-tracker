 ...
 */
export function renderNavbarHeader(): string {
    return `
 ...
 */
function renderPatientSelectionScreen(): string {
    const state = stateManager.getState();
 ...
 */
function renderTestDetailScreen(): string {
    const state = stateManager.getState();
    const testId = (window as any).__selectedTestId;
    const tests = state.tests || [];
 ...
 * Écran À propos
 */
function renderAboutScreen(): string {
    return `
